##THIS IS THE INITIAL SCRIPT THE PACKAGE WAS BUILT ON####
...
resultsDatabaseSchema <- "results_optum_extended_dod_v1913"

# A descriptive name of your database
sourceName <- "Optum DOD v1913"

# Create the connection details object for your database
connectionDetails <- DatabaseConnector::createConnectionDetails(dbms = "redshift",
                                                                connectionString = "CONNECTION",
                                                                user = Sys.getenv("OHDA_ETL_USER"),
                                                                password = Sys.getenv("OHDA_ETL_PASSWORD"))
