...
ui <- function(aresLink, appLogo, optionalScriptTag) {
  shiny::fluidPage(
    shinyjs::useShinyjs(),

    tags$head(
    	if (!is.null(optionalScriptTag)) {
    		HTML(optionalScriptTag)
    	}
    ),
    #UI Styles
    shiny::tags$head(
...
run_shiny_app <- function(
  ...
  shiny::shinyApp(
    ui = ui(aresLink, appLogo, optionalScriptTag),
